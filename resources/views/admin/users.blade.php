...
@sect                    <a href="{{ route('admin.users') }}" class="flex items-center px-4 py-3 bg-blue-600 rounded-lg text-white">
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-slate-800 text-white min-h-screen">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('admin.users') }}" class="flex items-center px-4 py-3 bg-blue-600 rounded-lg text-white">
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path>
                        </svg>
                        Users
        ...
        <div class="flex-1 p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">Manage all users on the platform</p>
            </div>
                            ...
                            @foreach($users as $user)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ $user->campaigns_count }} campaigns
                                    </td>
