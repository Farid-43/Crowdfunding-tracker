        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Admin Dashboard</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('campaigns.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-200">
                    View Public Site
                </a>
