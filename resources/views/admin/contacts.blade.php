        ...
        <div class="w-64 bg-slate-800 text-white flex-shrink-0">
            <div class="px-6 pb-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('admin.contacts') }}" class="flex items-center px-4 py-3 bg-blue-600 rounded-lg text-white">
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="flex-1 overflow-y-auto">
            <div class="p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 mt-2">Manage all customer inquiries and feedback</p>
                </div>
                ...
                @forelse($contacts as $contact)
                    <tr class="{{ $contact->status === 'pending' ? 'bg-yellow-50' : '' }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            @if($contact->status === 'pending')
                                <form action="{{ route('admin.contacts.mark-read', $contact->id) }}" method="POST" class="m-0">
                                    @csrf
                                    @method('PATCH')
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="mt-4 text-lg font-medium">No contact messages yet</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
